...
urlpatterns = [
    ...
    path('theme/<str:user_id>', views.ThemeViewSet.as_view(), name='theme'),
    # path('theme', views.theme_list, name='theme')
    path('themeDetail/<str:pk>', views.ThemeViewSetDetail.as_view(), name='themeDetail'),
    # https://tech-blog.rakus.co.jp/entry/20220329/python#2ViewSets
    path('', include(router.urls)),
    path('user/<str:pk>', views.UserAPIView.as_view(), name='userInfo'),
    # router.urls
]
